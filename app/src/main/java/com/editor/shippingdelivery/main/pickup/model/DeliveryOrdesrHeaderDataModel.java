...
public class DeliveryOrdesrHeaderDataModel extends BaseObservable implements Parcelable, Serializable
{
    /** distrCode. */
    ...
    private List<DeliveryOrdersDetailDataModel> deliveryOrdersDetailDataModelArrayList = new ArrayList<>();


    protected DeliveryOrdesrHeaderDataModel(Parcel in) {
        ...
        deliveryOrdersDetailDataModelArrayList = in.createTypedArrayList(DeliveryOrdersDetailDataModel.CREATOR);
    }

    public static final Creator<DeliveryOrdesrHeaderDataModel> CREATOR = new Creator<DeliveryOrdesrHeaderDataModel>() {
        @Override
        public DeliveryOrdesrHeaderDataModel createFromParcel(Parcel in) {
            return new DeliveryOrdesrHeaderDataModel(in);
        }

        @Override
        public DeliveryOrdesrHeaderDataModel[] newArray(int size) {
            return new DeliveryOrdesrHeaderDataModel[size];
        }
    };
    ...
    public List<DeliveryOrdersDetailDataModel> getDeliveryOrdersDetailDataModelArrayList() {
        return deliveryOrdersDetailDataModelArrayList;
    }

    public void setDeliveryOrdersDetailDataModelArrayList(List<DeliveryOrdersDetailDataModel> deliveryOrdersDetailDataModelArrayList) {
