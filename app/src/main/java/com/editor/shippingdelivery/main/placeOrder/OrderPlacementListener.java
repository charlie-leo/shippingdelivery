 ...
 */
public class OrderPlacementListener extends BaseObservable {
    ...
    @Bindable
    public OrderPlacementViewModel getOrderPlacementViewModel() {
        return orderPlacementViewModel;
    }

    public void setOrderPlacementViewModel(OrderPlacementViewModel orderPlacementViewModel) {
        this.orderPlacementViewModel = orderPlacementViewModel;
...
//        createOrderRequest.setOrderId(orderData.code);
    ...
    public void placeOrder(View view){
        orderPlacementViewModel.createShippingOrder(activity,createOrderRequest);
    }
}
