...
public class TrackingDeliveryOrdersDetailDataModel implements Parcelable {
    /**
     * distrCode.
     */
    ...
    protected TrackingDeliveryOrdersDetailDataModel(Parcel in) {
    ...
    public static final Creator<TrackingDeliveryOrdersDetailDataModel> CREATOR = new Creator<TrackingDeliveryOrdersDetailDataModel>() {
        @Override
        public TrackingDeliveryOrdersDetailDataModel createFromParcel(Parcel in) {
            return new TrackingDeliveryOrdersDetailDataModel(in);
        }

        @Override
        public TrackingDeliveryOrdersDetailDataModel[] newArray(int size) {
            return new TrackingDeliveryOrdersDetailDataModel[size];
        }
    };
