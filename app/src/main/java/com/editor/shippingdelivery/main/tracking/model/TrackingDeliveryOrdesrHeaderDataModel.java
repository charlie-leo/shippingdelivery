...
public class TrackingDeliveryOrdesrHeaderDataModel extends BaseObservable implements Parcelable, Serializable
{
    /** distrCode. */
    ...
    private List<TrackingDeliveryOrdersDetailDataModel> deliveryOrdersDetailDataModelArrayList = new ArrayList<>();


    protected TrackingDeliveryOrdesrHeaderDataModel(Parcel in) {
        ...
        deliveryOrdersDetailDataModelArrayList = in.createTypedArrayList(TrackingDeliveryOrdersDetailDataModel.CREATOR);
    }

    public static final Creator<TrackingDeliveryOrdesrHeaderDataModel> CREATOR = new Creator<TrackingDeliveryOrdesrHeaderDataModel>() {
        @Override
        public TrackingDeliveryOrdesrHeaderDataModel createFromParcel(Parcel in) {
            return new TrackingDeliveryOrdesrHeaderDataModel(in);
        }

        @Override
        public TrackingDeliveryOrdesrHeaderDataModel[] newArray(int size) {
            return new TrackingDeliveryOrdesrHeaderDataModel[size];
        }
    };
    ...
    public List<TrackingDeliveryOrdersDetailDataModel> getDeliveryOrdersDetailDataModelArrayList() {
        return deliveryOrdersDetailDataModelArrayList;
    }

    public void setDeliveryOrdersDetailDataModelArrayList(List<TrackingDeliveryOrdersDetailDataModel> deliveryOrdersDetailDataModelArrayList) {
        this.deliveryOrdersDetailDataModelArrayList = deliveryOrdersDetailDataModelArrayList;
    }
    ...
    public void writeToParcel(Parcel parcel, int i) {
        ...
        parcel.writeTypedList(deliveryOrdersDetailDataModelArrayList);
    }
}
