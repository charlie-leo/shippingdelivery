...
public class WhatsappStatusHeaderDataModel extends BaseObservable implements Parcelable
{
    ...
    protected WhatsappStatusHeaderDataModel(Parcel in) {
    ...
    public static final Creator<WhatsappStatusHeaderDataModel> CREATOR = new Creator<WhatsappStatusHeaderDataModel>() {
        @Override
        public WhatsappStatusHeaderDataModel createFromParcel(Parcel in) {
            return new WhatsappStatusHeaderDataModel(in);
        }

        @Override
        public WhatsappStatusHeaderDataModel[] newArray(int size) {
            return new WhatsappStatusHeaderDataModel[size];
        }
    };
    ...
    public void setWhatsappDeliveryDetailDataModelList(List<WhatsappDliveryDetailDataModel> whatsappDeliveryDetailDataModelList) {
        this.whatsappDeliveryDetailDataModelList = whatsappDeliveryDetailDataModelList;
    }
