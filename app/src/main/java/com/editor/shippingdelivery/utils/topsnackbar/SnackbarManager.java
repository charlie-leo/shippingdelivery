...
class SnackbarManager {
    ...
    private boolean cancelSnackbarLocked(SnackbarRecord snackbarRecord, int event) {
    ...
    private void handleTimeout(SnackbarRecord snackRecord) {
        synchronized (mLock) {
            if (mCurrentSnackbar == snackRecord || mNextSnackbar == snackRecord) {
                cancelSnackbarLocked(snackRecord, TSnackbar.Callback.DISMISS_EVENT_TIMEOUT);
            }
        }
    }
